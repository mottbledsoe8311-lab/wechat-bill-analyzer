  ...
  stats: router({
    ...
    recordShare: publicProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        await recordVisitorShare(input.visitorId);
        return { success: true };
      }),
    // 记录一次页面访问（PV）
