...
import BankCardExpenseSummary from '@/components/report/BankCardExpenseSummary';
          ...
          >
            <div className="min-h-screen bg-background">
              ...
              {/* 报表内容 */}
                ...
                <div id="bankcardsummary"><BankCardExpenseSummary transactions={allTransactions} /></div>
